...
| OPTION_PARITY_PRESSURE_V1 | cambio 5m del synthetic forward CALL/PUT 0DTE frente al spot | `ACTIVE` | runner 2023 preexecution-frozen SHA `f3819d88...26972`; one-shot pendiente |
...
mide una identidad cross-right de quotes 0DTE. La única apertura autorizada es
desarrollo 2023 tras freeze del runner; 2024–2026 y producción siguen cerrados.
