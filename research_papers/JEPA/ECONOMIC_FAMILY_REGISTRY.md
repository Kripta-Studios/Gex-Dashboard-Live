...
| OPTION_PARITY_PRESSURE_V1 | cambio 5m del synthetic forward CALL/PUT 0DTE frente al spot | `ACTIVE` | capacidad PASS: 752 fuentes/ticker, mínimo18/mes; data gate de quotes pendiente |
