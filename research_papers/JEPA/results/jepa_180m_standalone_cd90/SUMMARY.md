...
Mode: `base_jepa`
Rows scored: 2,200
Execution: fixed `180`m hold, cooldown `90`m, cost `1.0` bps, notional `$100,000`.

## Overall

| Scope | Trades | WR | PF | Avg bps | PnL | Max DD | Long Rate |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| all | 160 | 61.9% | 1.838 | 8.24 | +13,182 | -2,830 | 60.6% |

## Per Ticker

| Ticker | Trades | WR | PF | Avg bps | PnL | Max DD | Long Rate |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| QQQ | 70 | 55.7% | 1.570 | 7.28 | +5,096 | -2,830 | 64.3% |
| SPX | 45 | 66.7% | 3.823 | 13.78 | +6,199 | -869 | 55.6% |
| SPY | 45 | 66.7% | 1.411 | 4.19 | +1,887 | -1,430 | 60.0% |

## Cost Sensitivity

| Cost | Trades | WR | PF | Avg bps | PnL | Max DD | Long Rate |
| ---: | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| 1 bps | 160 | 61.9% | 1.838 | 8.24 | +13,182 | -2,830 | 60.6% |
| 3 bps | 160 | 59.4% | 1.588 | 6.24 | +9,982 | -3,070 | 60.6% |
| 5 bps | 160 | 58.1% | 1.370 | 4.24 | +6,782 | -3,310 | 60.6% |
| 10 bps | 160 | 48.8% | 0.945 | -0.76 | -1,218 | -3,947 | 60.6% |
