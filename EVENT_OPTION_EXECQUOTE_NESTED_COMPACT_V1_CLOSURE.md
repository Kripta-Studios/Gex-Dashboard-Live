...
> That separate outer-2024 runner is now frozen with 743 events and no outcome
> access. Its manifest and future execution remain independent of compact V1.
...
> A composite-consumer clarification for that separate source freezes its
...
> The overlay later completed 4/4 with zero missing shared keys, revisions or
> crossed quotes. This source repair still does not reopen compact V1.
