...
Actualización 2026-07-11 16:30 CEST — Predeclaración y código listos para PAIRWISE_OPPORTUNITY_AND_SIDE_SELECTION_V1. Se ha materializado la vista sellada `tmp/event_option_dataset_execquote_causal1030_202201_202512_pairwise_v1/event_option_dataset.parquet` conteniendo 97,625 filas y excluyendo por completo datos de 2026 (SHA-256: `d3c37b5f4511787ec19cf4478790377562b2b6c913185a2425f1b0cef7a3a408`). Los hiperparámetros de LightGBM están congelados, las features excluidas de la allowlist primaria son `dte_days`, `spot` y `underlying_volume` (este último por tener un valor constante). Los shifts agrupados garantizan no-leakage temporal. Tests unitarios en `tests/test_pairwise_opportunity_side.py` pasan correctamente (6 passed), asegurando que la evaluación y gates mensuales se ajustan estrictamente a las especificaciones.
